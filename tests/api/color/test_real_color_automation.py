...
class ColorAutomationTester:
    ...
    async def test_color_node_creation(self) -> bool:
        ...
        try:
            ...
            logger.info(
                f"✓ Color nodes created: {len(self.color_page.GetNodeList())} nodes"
            )
            return True
    ...
    async def test_color_keyframe_automation(self) -> bool:
        ...
        try:
            ...
            logger.info(
                f"✓ Keyframe animation created with {len(keyframe_frames)} keyframes"
            )
            return True
    ...
    async def test_color_temporal_smoothing(self) -> bool:
        ...
        try:
            ...
            logger.info(
                f"✓ Temporal smoothing applied with {len(smoothing_types)} curve types"
            )
            return True
