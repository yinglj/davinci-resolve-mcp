...
def register_keyframe_tools(mcp, resolve, logger):
    ...
    def get_timeline_item_keyframes(
        ...
        Args:
            timeline_item_id: ID of the timeline item to get keyframes for.
            property_name: Name of the property to get keyframes for.

        Returns:
            Dict[str, Any]: A dictionary containing the keyframes for the specified timeline item and property.
        """
        if resolve is None:
    ...
    def add_keyframe(
        ...
        Args:
            timeline_item_id: ID of the timeline item to add the keyframe to.
            property_name: Name of the property to add the keyframe to.
            frame: Frame number to add the keyframe at.
            value: Value of the property at the keyframe.
    ...
    def modify_keyframe(
        ...
        Args:
            timeline_item_id: ID of the timeline item to modify the keyframe for.
            property_name: Name of the property to modify the keyframe for.
            frame: Frame number of the keyframe to modify.
            new_value: New value for the keyframe.
            new_frame: New frame position for the keyframe.
    ...
    def delete_keyframe(timeline_item_id: str, property_name: str, frame: int) -> str:
        ...
        Args:
            timeline_item_id: ID of the timeline item to delete the keyframe from.
            property_name: Name of the property to delete the keyframe from.
    ...
    def set_keyframe_interpolation(
        ...
        Args:
            timeline_item_id: ID of the timeline item to set the keyframe interpolation for.
            property_name: Name of the property to set the keyframe interpolation for.
            frame: Frame number of the keyframe to set the interpolation for.
            interpolation_type: Type of interpolation to set for the keyframe.
    ...
    def enable_keyframes(timeline_item_id: str, keyframe_mode: str = "All") -> str:
        ...
        Args:
            timeline_item_id: ID of the timeline item to enable keyframe mode for.
            keyframe_mode: Mode of keyframe to enable ("All", "Video", "Audio").
