...
def register_project_tools(mcp, resolve, logger):
    ...
    def list_projects() -> List[str]:
        ...
        Returns:
            List[str]: A list of project names, or error if not connected.
        """
        if resolve is None:
    ...
    def get_current_project_name() -> str:
        ...
        Returns:
            str: The name of the current project, or an error message.
        """
        if resolve is None:
            return "Error: Not connected to DaVinci Resolve"
    ...
    def get_project_setting(setting_name: str) -> Dict[str, Any]:
        ...
        Returns:
            Dict[str, Any]: A dictionary containing the setting value.
        """
        if resolve is None:
            return {"error": "Not connected to DaVinci Resolve"}
