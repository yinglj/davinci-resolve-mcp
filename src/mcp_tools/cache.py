...
def register_cache_tools(mcp, resolve, logger):
    ...
    def set_cache_mode(mode: str) -> str:
        ...
        Args:
            mode: Cache mode to set (auto, on, off)

        Returns:
            str: Status message of the cache mode operation.
        """
        if resolve is None:
    ...
    def set_optimized_media_mode(mode: str) -> str:
        ...
        Args:
            mode: Optimized media mode to set (auto, on, off)

        Returns:
            str: Status message of the optimized media mode operation.
        """
        if resolve is None:
            return "Error: Not connected to DaVinci Resolve"
    ...
    def set_proxy_mode(mode: str) -> str:
        ...
        Args:
            mode: Proxy media mode to set (auto, on, off)

        Returns:
            str: Status message of the proxy media mode operation.
        """
        if resolve is None:
            return "Error: Not connected to DaVinci Resolve"
    ...
    def set_proxy_quality(quality: str) -> str:
        ...
        Args:
            quality: Proxy media quality to set (quarter, half, threeQuarter, full)

        Returns:
            str: Status message of the proxy media quality operation.
        """
        if resolve is None:
            return "Error: Not connected to DaVinci Resolve"
    ...
    def set_cache_path(path_type: str, path: str) -> str:
        ...
        Args:
            path_type: Type of cache path to set (local, network)
            path: Path to set for the cache

        Returns:
            str: Status message of the cache path operation.
        """
        if resolve is None:
            return "Error: Not connected to DaVinci Resolve"
    ...
    def generate_optimized_media(clip_names: List[str] = None) -> str:
        ...
        Args:
            clip_names: List of clip names to generate optimized media for

        Returns:
            str: Status message of the optimized media generation operation.
        """
        if resolve is None:
            return "Error: Not connected to DaVinci Resolve"
    ...
    def delete_optimized_media(clip_names: List[str] = None) -> str:
        ...
        Args:
            clip_names: List of clip names to delete optimized media for

        Returns:
            str: Status message of the optimized media deletion operation.
        """
        if resolve is None:
            return "Error: Not connected to DaVinci Resolve"
    ...
    def export_folder(
        ...
        Args:
            ...
            export_path: Path to export the folder to
            export_type: Type of export (DRB, XML, etc.)

        Returns:
            str: Status message of the export operation.
        """
        if resolve is None:
            return "Error: Not connected to DaVinci Resolve"
    ...
    def transcribe_folder_audio(folder_name: str, language: str = "en-US") -> str:
        ...
        Args:
            folder_name: Name of the folder to transcribe audio for
            language: Language to transcribe audio in

        Returns:
            str: Status message of the audio transcription operation.
        """
        if resolve is None:
            return "Error: Not connected to DaVinci Resolve"
    ...
    def clear_folder_transcription(folder_name: str) -> str:
        ...
        Args:
            folder_name: Name of the folder to clear transcription for

        Returns:
            str: Status message of the transcription clear operation.
        """
        if resolve is None:
            return "Error: Not connected to DaVinci Resolve"
